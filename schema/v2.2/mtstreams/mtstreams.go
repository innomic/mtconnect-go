...
// HashType is condensed message digest from a secure one-way hash function.
...
// DataItemSubEnumEnum is indicated by the presence or existence of something.
...
// UnitsExtType is Extended tyoe for same as {{block(DataItem)}} {{property(units)}}. See
...
// UnitsType is same as {{block(DataItem)}} {{property(units)}}. See {{package(Device
//         Information Model)}}.
...
// DewPointType is {{def(SampleEnum:DEW_POINT)}}
type DewPointType struct {
	*CommonSampleType
}

// DewPoint is {{def(SampleEnum:DEW_POINT)}}
type DewPoint *DewPointType

// DewPointTimeSeriesType is Time series of {{def(SampleEnum:DEW_POINT)}}
type DewPointTimeSeriesType struct {
	*TimeSeriesType
}

// DewPointTimeSeries is Time series of {{def(SampleEnum:DEW_POINT)}}
type DewPointTimeSeries *DewPointTimeSeriesType

// GravitationalForceType is {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note: $$Mass\times
//         GravitationalAcceleration$$
type GravitationalForceType struct {
	*CommonSampleType
}

// GravitationalForce is {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note: $$Mass\times
//         GravitationalAcceleration$$
type GravitationalForce *GravitationalForceType

// GravitationalForceTimeSeriesType is Time series of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note:
//         $$Mass\times GravitationalAcceleration$$
type GravitationalForceTimeSeriesType struct {
	*TimeSeriesType
}

// GravitationalForceTimeSeries is Time series of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note:
//         $$Mass\times GravitationalAcceleration$$
type GravitationalForceTimeSeries *GravitationalForceTimeSeriesType

// GravitationalAccelerationType is {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationType struct {
	*CommonSampleType
}

// GravitationalAcceleration is {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAcceleration *GravitationalAccelerationType

// GravitationalAccelerationTimeSeriesType is Time series of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationTimeSeriesType struct {
	*TimeSeriesType
}

// GravitationalAccelerationTimeSeries is Time series of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationTimeSeries *GravitationalAccelerationTimeSeriesType

// BatteryCapacityType is {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityType struct {
	*CommonSampleType
}

// BatteryCapacity is {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacity *BatteryCapacityType

// BatteryCapacityTimeSeriesType is Time series of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityTimeSeriesType struct {
	*TimeSeriesType
}

// BatteryCapacityTimeSeries is Time series of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityTimeSeries *BatteryCapacityTimeSeriesType

// DischargeRateType is {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateType struct {
	*CommonSampleType
}

// DischargeRate is {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRate *DischargeRateType

// DischargeRateTimeSeriesType is Time series of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateTimeSeriesType struct {
	*TimeSeriesType
}

// DischargeRateTimeSeries is Time series of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateTimeSeries *DischargeRateTimeSeriesType

// ChargeRateType is {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateType struct {
	*CommonSampleType
}

// ChargeRate is {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRate *ChargeRateType

// ChargeRateTimeSeriesType is Time series of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateTimeSeriesType struct {
	*TimeSeriesType
}

// ChargeRateTimeSeries is Time series of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateTimeSeries *ChargeRateTimeSeriesType

// BatteryChargeType is {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeType struct {
	*CommonSampleType
}

// BatteryCharge is {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryCharge *BatteryChargeType

// BatteryChargeTimeSeriesType is Time series of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeTimeSeriesType struct {
	*TimeSeriesType
}

// BatteryChargeTimeSeries is Time series of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeTimeSeries *BatteryChargeTimeSeriesType

// SettlingErrorType is {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorType struct {
	*CommonSampleType
}

// SettlingError is {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingError *SettlingErrorType

// SettlingErrorTimeSeriesType is Time series of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorTimeSeriesType struct {
	*TimeSeriesType
}

// SettlingErrorTimeSeries is Time series of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorTimeSeries *SettlingErrorTimeSeriesType

// SettlingErrorLinearType is {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearType struct {
	*CommonSampleType
}

// SettlingErrorLinear is {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinear *SettlingErrorLinearType

// SettlingErrorLinearTimeSeriesType is Time series of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearTimeSeriesType struct {
	*TimeSeriesType
}

// SettlingErrorLinearTimeSeries is Time series of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearTimeSeries *SettlingErrorLinearTimeSeriesType

// SettlingErrorAngularType is {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularType struct {
	*CommonSampleType
}

// SettlingErrorAngular is {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngular *SettlingErrorAngularType

// SettlingErrorAngularTimeSeriesType is Time series of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularTimeSeriesType struct {
	*TimeSeriesType
}

// SettlingErrorAngularTimeSeries is Time series of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularTimeSeries *SettlingErrorAngularTimeSeriesType

// FollowingErrorType is {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorType struct {
	*CommonSampleType
}

// FollowingError is {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingError *FollowingErrorType

// FollowingErrorTimeSeriesType is Time series of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorTimeSeriesType struct {
	*TimeSeriesType
}

// FollowingErrorTimeSeries is Time series of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorTimeSeries *FollowingErrorTimeSeriesType

// FollowingErrorAngularType is {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularType struct {
	*CommonSampleType
}

// FollowingErrorAngular is {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngular *FollowingErrorAngularType

// FollowingErrorAngularTimeSeriesType is Time series of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularTimeSeriesType struct {
	*TimeSeriesType
}

// FollowingErrorAngularTimeSeries is Time series of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularTimeSeries *FollowingErrorAngularTimeSeriesType

// FollowingErrorLinearType is {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearType struct {
	*CommonSampleType
}

// FollowingErrorLinear is {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinear *FollowingErrorLinearType

// FollowingErrorLinearTimeSeriesType is Time series of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearTimeSeriesType struct {
	*TimeSeriesType
}

// FollowingErrorLinearTimeSeries is Time series of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearTimeSeries *FollowingErrorLinearTimeSeriesType

// DisplacementLinearType is {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The displacement
//         vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearType struct {
	*CommonSampleType
}

// DisplacementLinear is {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The displacement
//         vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinear *DisplacementLinearType

// DisplacementLinearTimeSeriesType is Time series of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearTimeSeriesType struct {
	*TimeSeriesType
}

// DisplacementLinearTimeSeries is Time series of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearTimeSeries *DisplacementLinearTimeSeriesType

// DisplacementAngularType is {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The displacement
//         vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularType struct {
	*CommonSampleType
}

// DisplacementAngular is {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The displacement
//         vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngular *DisplacementAngularType

// DisplacementAngularTimeSeriesType is Time series of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularTimeSeriesType struct {
	*TimeSeriesType
}

// DisplacementAngularTimeSeries is Time series of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularTimeSeries *DisplacementAngularTimeSeriesType

// PositionCartesianType is {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesianType struct {
	*ThreeSpaceSampleType
}

// PositionCartesian is {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesian *PositionCartesianType
...
// StringEventValueType is String event value
type StringEventValueType struct {
	String               string
	UnavailableValueType string
}

// DateTimeEventValueType is DateTime String event value
type DateTimeEventValueType struct {
	DateTime             string
	UnavailableValueType string
}
...
// DateTimeEventType is An unfaceted datetime event
type DateTimeEventType struct {
}

// DateTimeEvent is An unfaceted datetime event
type DateTimeEvent *DateTimeEventType
...
type AssetChangedType struct {
	...
	HashAttr      string `xml:"hash,attr,omitempty"`
	*StringEventType
}
...
// WaitStateType is {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
...
// WaitState is {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
//         {{property(result)}} is not `WAIT`, the
//         {{property(Observation::isUnavailable)}} property of
//         {{block(WaitState)}} **MUST** be `true`.
...
// ClockTimeType is {{def(EventEnum:CLOCK_TIME)}}
type ClockTimeType struct {
	*DateTimeEventType
}

// ClockTime is {{def(EventEnum:CLOCK_TIME)}}
type ClockTime *ClockTimeType

// NetworkPortType is {{def(EventEnum:NETWORK_PORT)}}
type NetworkPortType struct {
	*IntegerEventType
}

// NetworkPort is {{def(EventEnum:NETWORK_PORT)}}
type NetworkPort *NetworkPortType

// HostNameType is {{def(EventEnum:HOST_NAME)}}
type HostNameType struct {
	*StringEventType
}

// HostName is {{def(EventEnum:HOST_NAME)}}
type HostName *HostNameType

// LeakDetectValueType is Value is indeterminate
type LeakDetectValueType string

// LeakDetectType is {{def(EventEnum:LEAK_DETECT)}}
type LeakDetectType struct {
}

// LeakDetect is {{def(EventEnum:LEAK_DETECT)}}
type LeakDetect *LeakDetectType

// BatteryStateValueType is Value is indeterminate
type BatteryStateValueType string

// BatteryStateType is {{def(EventEnum:BATTERY_STATE)}}
type BatteryStateType struct {
}

// BatteryState is {{def(EventEnum:BATTERY_STATE)}}
type BatteryState *BatteryStateType

// FeaturePersisitentIdType is {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentIdType struct {
	*StringEventType
}

// FeaturePersisitentId is {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentId *FeaturePersisitentIdType

// SensorStateType is {{def(EventEnum:SENSOR_STATE)}}
type SensorStateType struct {
	*StringEventType
}

// SensorState is {{def(EventEnum:SENSOR_STATE)}}
type SensorState *SensorStateType

// ComponentDataType is tabular {{def(EventEnum:COMPONENT_DATA)}} If the {{block(Component)}}
...
// ComponentData is tabular {{def(EventEnum:COMPONENT_DATA)}} If the {{block(Component)}}
//         multiplicity can be determined, the device model **MUST** use a fixed
//         set of {{block(Component)}}s. {{block(ComponentData)}} **MUST** provide
//         a {{block(DataItem)}} {{block(Definition)}}.
type ComponentData *ComponentDataType

// WorkOffsetsType is tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsetsType struct {
	*StringEventType
}

// WorkOffsets is tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsets *WorkOffsetsType

// ToolOffsetsType is tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsetsType struct {
	*StringEventType
}

// ToolOffsets is tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsets *ToolOffsetsType

// FeatureMeasurementType is tabular representation of {{def(EventEnum:FEATURE_MEASUREMENT)}}
//         {{block(FeatureMeasurement)}} **MAY** include a {{term(characteristic)}}
//         in which case it **MAY** include a `CHARACTERISTIC_STATUS`.
type FeatureMeasurementType struct {
	*StringEventType
}

// FeatureMeasurement is tabular representation of {{def(EventEnum:FEATURE_MEASUREMENT)}}
//         {{block(FeatureMeasurement)}} **MAY** include a {{term(characteristic)}}
//         in which case it **MAY** include a `CHARACTERISTIC_STATUS`.
type FeatureMeasurement *FeatureMeasurementType

// CharacteristicPersistentIdType is {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentIdType struct {
	*StringEventType
}

// CharacteristicPersistentId is {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentId *CharacteristicPersistentIdType

// MeasurementTypeType is {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`, `RADIUS`,
//         `ANGLE`, `LENGTH`, etc.
type MeasurementTypeType struct {
	*StringEventType
}

// MeasurementType is {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`, `RADIUS`,
//         `ANGLE`, `LENGTH`, etc.
type MeasurementType *MeasurementTypeType

// MeasurementValueType is {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValueType struct {
	*FloatEventType
}

// MeasurementValue is {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValue *MeasurementValueType

// MeasurementUnitsType is {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnitsType struct {
	*StringEventType
}

// MeasurementUnits is {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnits *MeasurementUnitsType

// CharacteristicStatusValueType is Value is indeterminate
type CharacteristicStatusValueType string

// CharacteristicStatusType is {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatusType struct {
}

// CharacteristicStatus is {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatus *CharacteristicStatusType

// UncertaintyTypeValueType is Value is indeterminate
type UncertaintyTypeValueType string

// UncertaintyTypeType is {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyTypeType struct {
}

// UncertaintyType is {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyType *UncertaintyTypeType

// Uncertainty is {{def(EventEnum:UNCERTAINTY)}}
type Uncertainty *UncertaintyTypeType
...
// WaitStateEntryType is DataSet of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
//         {{property(result)}} is not `WAIT`, the
//         {{property(Observation::isUnavailable)}} property of
//         {{block(WaitState)}} **MUST** be `true`.
...
// WaitStateEntry is DataSet of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
//         {{property(result)}} is not `WAIT`, the
//         {{property(Observation::isUnavailable)}} property of
//         {{block(WaitState)}} **MUST** be `true`.
...
// WaitStateDataSet is DataSet of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
//         {{property(result)}} is not `WAIT`, the
//         {{property(Observation::isUnavailable)}} property of
//         {{block(WaitState)}} **MUST** be `true`.
type WaitStateDataSet *WaitStateDataSetType

// WireEntryType is DataSet of leaf {{block(Component)}} composed of a string like piece or
//         filament of relatively rigid or flexible material provided in a variety
//         of diameters.
type WireEntryType struct {
}

// WireEntry is DataSet of leaf {{block(Component)}} composed of a string like piece or
//         filament of relatively rigid or flexible material provided in a variety
//         of diameters.
...
// WireDataSet is DataSet of leaf {{block(Component)}} composed of a string like piece or
//         filament of relatively rigid or flexible material provided in a variety
//         of diameters.
...
// ClockTimeEntryType is DataSet of {{def(EventEnum:CLOCK_TIME)}}
type ClockTimeEntryType struct {
}

// ClockTimeEntry is DataSet of {{def(EventEnum:CLOCK_TIME)}}
type ClockTimeEntry *ClockTimeEntryType

// ClockTimeDataSetType is Constraints for Entry Values
type ClockTimeDataSetType struct {
	CountAttr int                   `xml:"count,attr"`
	Entry     []*ClockTimeEntryType `xml:"Entry"`
	*EventType
}

// ClockTimeDataSet is DataSet of {{def(EventEnum:CLOCK_TIME)}}
type ClockTimeDataSet *ClockTimeDataSetType

// NetworkPortEntryType is DataSet of {{def(EventEnum:NETWORK_PORT)}}
type NetworkPortEntryType struct {
}

// NetworkPortEntry is DataSet of {{def(EventEnum:NETWORK_PORT)}}
type NetworkPortEntry *NetworkPortEntryType

// NetworkPortDataSetType is Constraints for Entry Values
type NetworkPortDataSetType struct {
	CountAttr int                     `xml:"count,attr"`
	Entry     []*NetworkPortEntryType `xml:"Entry"`
	*EventType
}

// NetworkPortDataSet is DataSet of {{def(EventEnum:NETWORK_PORT)}}
type NetworkPortDataSet *NetworkPortDataSetType

// HostNameEntryType is DataSet of {{def(EventEnum:HOST_NAME)}}
type HostNameEntryType struct {
}

// HostNameEntry is DataSet of {{def(EventEnum:HOST_NAME)}}
type HostNameEntry *HostNameEntryType

// HostNameDataSetType is Constraints for Entry Values
type HostNameDataSetType struct {
	CountAttr int                  `xml:"count,attr"`
	Entry     []*HostNameEntryType `xml:"Entry"`
	*EventType
}

// HostNameDataSet is DataSet of {{def(EventEnum:HOST_NAME)}}
type HostNameDataSet *HostNameDataSetType

// LeakDetectEntryType is DataSet of {{def(EventEnum:LEAK_DETECT)}}
type LeakDetectEntryType struct {
}

// LeakDetectEntry is DataSet of {{def(EventEnum:LEAK_DETECT)}}
type LeakDetectEntry *LeakDetectEntryType

// LeakDetectDataSetType is Constraints for Entry Values
type LeakDetectDataSetType struct {
	CountAttr int                    `xml:"count,attr"`
	Entry     []*LeakDetectEntryType `xml:"Entry"`
	*EventType
}

// LeakDetectDataSet is DataSet of {{def(EventEnum:LEAK_DETECT)}}
type LeakDetectDataSet *LeakDetectDataSetType

// BatteryStateEntryType is DataSet of {{def(EventEnum:BATTERY_STATE)}}
type BatteryStateEntryType struct {
}

// BatteryStateEntry is DataSet of {{def(EventEnum:BATTERY_STATE)}}
type BatteryStateEntry *BatteryStateEntryType

// BatteryStateDataSetType is Constraints for Entry Values
type BatteryStateDataSetType struct {
	CountAttr int                      `xml:"count,attr"`
	Entry     []*BatteryStateEntryType `xml:"Entry"`
	*EventType
}

// BatteryStateDataSet is DataSet of {{def(EventEnum:BATTERY_STATE)}}
type BatteryStateDataSet *BatteryStateDataSetType

// FeaturePersisitentIdEntryType is DataSet of {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentIdEntryType struct {
}

// FeaturePersisitentIdEntry is DataSet of {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentIdEntry *FeaturePersisitentIdEntryType

// FeaturePersisitentIdDataSetType is Constraints for Entry Values
type FeaturePersisitentIdDataSetType struct {
	CountAttr int                              `xml:"count,attr"`
	Entry     []*FeaturePersisitentIdEntryType `xml:"Entry"`
	*EventType
}

// FeaturePersisitentIdDataSet is DataSet of {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentIdDataSet *FeaturePersisitentIdDataSetType

// SensorStateEntryType is DataSet of {{def(EventEnum:SENSOR_STATE)}}
type SensorStateEntryType struct {
}

// SensorStateEntry is DataSet of {{def(EventEnum:SENSOR_STATE)}}
type SensorStateEntry *SensorStateEntryType

// SensorStateDataSetType is Constraints for Entry Values
type SensorStateDataSetType struct {
	CountAttr int                     `xml:"count,attr"`
	Entry     []*SensorStateEntryType `xml:"Entry"`
	*EventType
}

// SensorStateDataSet is DataSet of {{def(EventEnum:SENSOR_STATE)}}
type SensorStateDataSet *SensorStateDataSetType

// ComponentDataEntryType is DataSet of tabular {{def(EventEnum:COMPONENT_DATA)}} If the
...
//         {{block(Definition)}}.
type ComponentDataEntryType struct {
}

// ComponentDataEntry is DataSet of tabular {{def(EventEnum:COMPONENT_DATA)}} If the
//         {{block(Component)}} multiplicity can be determined, the device model
//         **MUST** use a fixed set of {{block(Component)}}s.
//         {{block(ComponentData)}} **MUST** provide a {{block(DataItem)}}
//         {{block(Definition)}}.
type ComponentDataEntry *ComponentDataEntryType

// ComponentDataDataSetType is Constraints for Entry Values
type ComponentDataDataSetType struct {
	CountAttr int                       `xml:"count,attr"`
	Entry     []*ComponentDataEntryType `xml:"Entry"`
	*EventType
}

// ComponentDataDataSet is DataSet of tabular {{def(EventEnum:COMPONENT_DATA)}} If the
//         {{block(Component)}} multiplicity can be determined, the device model
//         **MUST** use a fixed set of {{block(Component)}}s.
//         {{block(ComponentData)}} **MUST** provide a {{block(DataItem)}}
//         {{block(Definition)}}.
type ComponentDataDataSet *ComponentDataDataSetType

// WorkOffsetsEntryType is DataSet of tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsetsEntryType struct {
}

// WorkOffsetsEntry is DataSet of tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsetsEntry *WorkOffsetsEntryType

// WorkOffsetsDataSetType is Constraints for Entry Values
type WorkOffsetsDataSetType struct {
	CountAttr int                     `xml:"count,attr"`
	Entry     []*WorkOffsetsEntryType `xml:"Entry"`
	*EventType
}

// WorkOffsetsDataSet is DataSet of tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsetsDataSet *WorkOffsetsDataSetType

// ToolOffsetsEntryType is DataSet of tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsetsEntryType struct {
}

// ToolOffsetsEntry is DataSet of tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsetsEntry *ToolOffsetsEntryType

// ToolOffsetsDataSetType is Constraints for Entry Values
type ToolOffsetsDataSetType struct {
	CountAttr int                     `xml:"count,attr"`
	Entry     []*ToolOffsetsEntryType `xml:"Entry"`
	*EventType
}

// ToolOffsetsDataSet is DataSet of tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsetsDataSet *ToolOffsetsDataSetType

// FeatureMeasurementEntryType is DataSet of tabular representation of
...
type FeatureMeasurementEntryType struct {
}

// FeatureMeasurementEntry is DataSet of tabular representation of
//         {{def(EventEnum:FEATURE_MEASUREMENT)}} {{block(FeatureMeasurement)}}
//         **MAY** include a {{term(characteristic)}} in which case it **MAY**
//         include a `CHARACTERISTIC_STATUS`.
type FeatureMeasurementEntry *FeatureMeasurementEntryType

// FeatureMeasurementDataSetType is Constraints for Entry Values
type FeatureMeasurementDataSetType struct {
	CountAttr int                            `xml:"count,attr"`
	Entry     []*FeatureMeasurementEntryType `xml:"Entry"`
	*EventType
}

// FeatureMeasurementDataSet is DataSet of tabular representation of
//         {{def(EventEnum:FEATURE_MEASUREMENT)}} {{block(FeatureMeasurement)}}
//         **MAY** include a {{term(characteristic)}} in which case it **MAY**
//         include a `CHARACTERISTIC_STATUS`.
type FeatureMeasurementDataSet *FeatureMeasurementDataSetType

// CharacteristicPersistentIdEntryType is DataSet of {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentIdEntryType struct {
}

// CharacteristicPersistentIdEntry is DataSet of {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentIdEntry *CharacteristicPersistentIdEntryType

// CharacteristicPersistentIdDataSetType is Constraints for Entry Values
type CharacteristicPersistentIdDataSetType struct {
	CountAttr int                                    `xml:"count,attr"`
	Entry     []*CharacteristicPersistentIdEntryType `xml:"Entry"`
	*EventType
}

// CharacteristicPersistentIdDataSet is DataSet of {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentIdDataSet *CharacteristicPersistentIdDataSetType

// MeasurementTypeEntryType is DataSet of {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`,
//         `RADIUS`, `ANGLE`, `LENGTH`, etc.
type MeasurementTypeEntryType struct {
}

// MeasurementTypeEntry is DataSet of {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`,
//         `RADIUS`, `ANGLE`, `LENGTH`, etc.
type MeasurementTypeEntry *MeasurementTypeEntryType

// MeasurementTypeDataSetType is Constraints for Entry Values
type MeasurementTypeDataSetType struct {
	CountAttr int                         `xml:"count,attr"`
	Entry     []*MeasurementTypeEntryType `xml:"Entry"`
	*EventType
}

// MeasurementTypeDataSet is DataSet of {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`,
//         `RADIUS`, `ANGLE`, `LENGTH`, etc.
type MeasurementTypeDataSet *MeasurementTypeDataSetType

// MeasurementValueEntryType is DataSet of {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValueEntryType struct {
}

// MeasurementValueEntry is DataSet of {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValueEntry *MeasurementValueEntryType

// MeasurementValueDataSetType is Constraints for Entry Values
type MeasurementValueDataSetType struct {
	CountAttr int                          `xml:"count,attr"`
	Entry     []*MeasurementValueEntryType `xml:"Entry"`
	*EventType
}

// MeasurementValueDataSet is DataSet of {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValueDataSet *MeasurementValueDataSetType

// MeasurementUnitsEntryType is DataSet of {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnitsEntryType struct {
}

// MeasurementUnitsEntry is DataSet of {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnitsEntry *MeasurementUnitsEntryType

// MeasurementUnitsDataSetType is Constraints for Entry Values
type MeasurementUnitsDataSetType struct {
	CountAttr int                          `xml:"count,attr"`
	Entry     []*MeasurementUnitsEntryType `xml:"Entry"`
	*EventType
}

// MeasurementUnitsDataSet is DataSet of {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnitsDataSet *MeasurementUnitsDataSetType

// CharacteristicStatusEntryType is DataSet of {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatusEntryType struct {
}

// CharacteristicStatusEntry is DataSet of {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatusEntry *CharacteristicStatusEntryType

// CharacteristicStatusDataSetType is Constraints for Entry Values
type CharacteristicStatusDataSetType struct {
	CountAttr int                              `xml:"count,attr"`
	Entry     []*CharacteristicStatusEntryType `xml:"Entry"`
	*EventType
}

// CharacteristicStatusDataSet is DataSet of {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatusDataSet *CharacteristicStatusDataSetType

// UncertaintyTypeEntryType is DataSet of {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyTypeEntryType struct {
}

// UncertaintyTypeEntry is DataSet of {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyTypeEntry *UncertaintyTypeEntryType

// UncertaintyTypeDataSetType is Constraints for Entry Values
type UncertaintyTypeDataSetType struct {
	CountAttr int                         `xml:"count,attr"`
	Entry     []*UncertaintyTypeEntryType `xml:"Entry"`
	*EventType
}

// UncertaintyTypeDataSet is DataSet of {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyTypeDataSet *UncertaintyTypeDataSetType

// UncertaintyEntryType is DataSet of {{def(EventEnum:UNCERTAINTY)}}
type UncertaintyEntryType struct {
}

// UncertaintyEntry is DataSet of {{def(EventEnum:UNCERTAINTY)}}
type UncertaintyEntry *UncertaintyEntryType

// UncertaintyDataSetType is Constraints for Entry Values
type UncertaintyDataSetType struct {
	CountAttr int                     `xml:"count,attr"`
	Entry     []*UncertaintyEntryType `xml:"Entry"`
	*EventType
}

// UncertaintyDataSet is DataSet of {{def(EventEnum:UNCERTAINTY)}}
type UncertaintyDataSet *UncertaintyDataSetType
...
// DewPointEntryType is DataSet of {{def(SampleEnum:DEW_POINT)}}
type DewPointEntryType struct {
}

// DewPointEntry is DataSet of {{def(SampleEnum:DEW_POINT)}}
type DewPointEntry *DewPointEntryType

// DewPointDataSetType is Constraints for Entry Values
type DewPointDataSetType struct {
	CountAttr int                  `xml:"count,attr"`
	Entry     []*DewPointEntryType `xml:"Entry"`
	*EventType
}

// DewPointDataSet is DataSet of {{def(SampleEnum:DEW_POINT)}}
type DewPointDataSet *DewPointDataSetType

// GravitationalForceEntryType is DataSet of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note:
//         $$Mass\times GravitationalAcceleration$$
type GravitationalForceEntryType struct {
}

// GravitationalForceEntry is DataSet of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note:
//         $$Mass\times GravitationalAcceleration$$
type GravitationalForceEntry *GravitationalForceEntryType

// GravitationalForceDataSetType is Constraints for Entry Values
type GravitationalForceDataSetType struct {
	CountAttr int                            `xml:"count,attr"`
	Entry     []*GravitationalForceEntryType `xml:"Entry"`
	*EventType
}

// GravitationalForceDataSet is DataSet of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note:
//         $$Mass\times GravitationalAcceleration$$
type GravitationalForceDataSet *GravitationalForceDataSetType

// GravitationalAccelerationEntryType is DataSet of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationEntryType struct {
}

// GravitationalAccelerationEntry is DataSet of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationEntry *GravitationalAccelerationEntryType

// GravitationalAccelerationDataSetType is Constraints for Entry Values
type GravitationalAccelerationDataSetType struct {
	CountAttr int                                   `xml:"count,attr"`
	Entry     []*GravitationalAccelerationEntryType `xml:"Entry"`
	*EventType
}

// GravitationalAccelerationDataSet is DataSet of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationDataSet *GravitationalAccelerationDataSetType

// BatteryCapacityEntryType is DataSet of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityEntryType struct {
}

// BatteryCapacityEntry is DataSet of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityEntry *BatteryCapacityEntryType

// BatteryCapacityDataSetType is Constraints for Entry Values
type BatteryCapacityDataSetType struct {
	CountAttr int                         `xml:"count,attr"`
	Entry     []*BatteryCapacityEntryType `xml:"Entry"`
	*EventType
}

// BatteryCapacityDataSet is DataSet of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityDataSet *BatteryCapacityDataSetType

// DischargeRateEntryType is DataSet of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateEntryType struct {
}

// DischargeRateEntry is DataSet of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateEntry *DischargeRateEntryType

// DischargeRateDataSetType is Constraints for Entry Values
type DischargeRateDataSetType struct {
	CountAttr int                       `xml:"count,attr"`
	Entry     []*DischargeRateEntryType `xml:"Entry"`
	*EventType
}

// DischargeRateDataSet is DataSet of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateDataSet *DischargeRateDataSetType

// ChargeRateEntryType is DataSet of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateEntryType struct {
}

// ChargeRateEntry is DataSet of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateEntry *ChargeRateEntryType

// ChargeRateDataSetType is Constraints for Entry Values
type ChargeRateDataSetType struct {
	CountAttr int                    `xml:"count,attr"`
	Entry     []*ChargeRateEntryType `xml:"Entry"`
	*EventType
}

// ChargeRateDataSet is DataSet of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateDataSet *ChargeRateDataSetType

// BatteryChargeEntryType is DataSet of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeEntryType struct {
}

// BatteryChargeEntry is DataSet of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeEntry *BatteryChargeEntryType

// BatteryChargeDataSetType is Constraints for Entry Values
type BatteryChargeDataSetType struct {
	CountAttr int                       `xml:"count,attr"`
	Entry     []*BatteryChargeEntryType `xml:"Entry"`
	*EventType
}

// BatteryChargeDataSet is DataSet of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeDataSet *BatteryChargeDataSetType

// SettlingErrorEntryType is DataSet of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorEntryType struct {
}

// SettlingErrorEntry is DataSet of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorEntry *SettlingErrorEntryType

// SettlingErrorDataSetType is Constraints for Entry Values
type SettlingErrorDataSetType struct {
	CountAttr int                       `xml:"count,attr"`
	Entry     []*SettlingErrorEntryType `xml:"Entry"`
	*EventType
}

// SettlingErrorDataSet is DataSet of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorDataSet *SettlingErrorDataSetType

// SettlingErrorLinearEntryType is DataSet of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearEntryType struct {
}

// SettlingErrorLinearEntry is DataSet of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearEntry *SettlingErrorLinearEntryType

// SettlingErrorLinearDataSetType is Constraints for Entry Values
type SettlingErrorLinearDataSetType struct {
	CountAttr int                             `xml:"count,attr"`
	Entry     []*SettlingErrorLinearEntryType `xml:"Entry"`
	*EventType
}

// SettlingErrorLinearDataSet is DataSet of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearDataSet *SettlingErrorLinearDataSetType

// SettlingErrorAngularEntryType is DataSet of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularEntryType struct {
}

// SettlingErrorAngularEntry is DataSet of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularEntry *SettlingErrorAngularEntryType

// SettlingErrorAngularDataSetType is Constraints for Entry Values
type SettlingErrorAngularDataSetType struct {
	CountAttr int                              `xml:"count,attr"`
	Entry     []*SettlingErrorAngularEntryType `xml:"Entry"`
	*EventType
}

// SettlingErrorAngularDataSet is DataSet of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularDataSet *SettlingErrorAngularDataSetType

// FollowingErrorEntryType is DataSet of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorEntryType struct {
}

// FollowingErrorEntry is DataSet of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorEntry *FollowingErrorEntryType

// FollowingErrorDataSetType is Constraints for Entry Values
type FollowingErrorDataSetType struct {
	CountAttr int                        `xml:"count,attr"`
	Entry     []*FollowingErrorEntryType `xml:"Entry"`
	*EventType
}

// FollowingErrorDataSet is DataSet of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorDataSet *FollowingErrorDataSetType

// FollowingErrorAngularEntryType is DataSet of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularEntryType struct {
}

// FollowingErrorAngularEntry is DataSet of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularEntry *FollowingErrorAngularEntryType

// FollowingErrorAngularDataSetType is Constraints for Entry Values
type FollowingErrorAngularDataSetType struct {
	CountAttr int                               `xml:"count,attr"`
	Entry     []*FollowingErrorAngularEntryType `xml:"Entry"`
	*EventType
}

// FollowingErrorAngularDataSet is DataSet of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularDataSet *FollowingErrorAngularDataSetType

// FollowingErrorLinearEntryType is DataSet of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearEntryType struct {
}

// FollowingErrorLinearEntry is DataSet of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearEntry *FollowingErrorLinearEntryType

// FollowingErrorLinearDataSetType is Constraints for Entry Values
type FollowingErrorLinearDataSetType struct {
	CountAttr int                              `xml:"count,attr"`
	Entry     []*FollowingErrorLinearEntryType `xml:"Entry"`
	*EventType
}

// FollowingErrorLinearDataSet is DataSet of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearDataSet *FollowingErrorLinearDataSetType

// DisplacementLinearEntryType is DataSet of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearEntryType struct {
}

// DisplacementLinearEntry is DataSet of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearEntry *DisplacementLinearEntryType

// DisplacementLinearDataSetType is Constraints for Entry Values
type DisplacementLinearDataSetType struct {
	CountAttr int                            `xml:"count,attr"`
	Entry     []*DisplacementLinearEntryType `xml:"Entry"`
	*EventType
}

// DisplacementLinearDataSet is DataSet of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearDataSet *DisplacementLinearDataSetType

// DisplacementAngularEntryType is DataSet of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularEntryType struct {
}

// DisplacementAngularEntry is DataSet of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularEntry *DisplacementAngularEntryType

// DisplacementAngularDataSetType is Constraints for Entry Values
type DisplacementAngularDataSetType struct {
	CountAttr int                             `xml:"count,attr"`
	Entry     []*DisplacementAngularEntryType `xml:"Entry"`
	*EventType
}

// DisplacementAngularDataSet is DataSet of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularDataSet *DisplacementAngularDataSetType

// PositionCartesianEntryType is DataSet of {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesianEntryType struct {
}

// PositionCartesianEntry is DataSet of {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesianEntry *PositionCartesianEntryType

// PositionCartesianDataSetType is Constraints for Entry Values
type PositionCartesianDataSetType struct {
	CountAttr int                           `xml:"count,attr"`
	Entry     []*PositionCartesianEntryType `xml:"Entry"`
	*EventType
}

// PositionCartesianDataSet is DataSet of {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesianDataSet *PositionCartesianDataSetType
...
// WaitStateTableEntry is Table Entry of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
//         {{property(result)}} is not `WAIT`, the
//         {{property(Observation::isUnavailable)}} property of
//         {{block(WaitState)}} **MUST** be `true`.
type WaitStateTableEntry *WaitStateTableEntryType

// WaitStateCellType is Cell of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
//         {{property(result)}} is not `WAIT`, the
//         {{property(Observation::isUnavailable)}} property of
//         {{block(WaitState)}} **MUST** be `true`.
...
// WaitStateCell is Cell of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
//         {{property(result)}} is not `WAIT`, the
//         {{property(Observation::isUnavailable)}} property of
//         {{block(WaitState)}} **MUST** be `true`.
...
// WaitStateTable is Table of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
//         {{property(result)}} is not `WAIT`, the
//         {{property(Observation::isUnavailable)}} property of
//         {{block(WaitState)}} **MUST** be `true`.
...
// WireTableEntry is Table Entry of leaf {{block(Component)}} composed of a string like piece
...
// WireCellType is Cell of leaf {{block(Component)}} composed of a string like piece or
//         filament of relatively rigid or flexible material provided in a variety
//         of diameters.
type WireCellType struct {
}

// WireCell is Cell of leaf {{block(Component)}} composed of a string like piece or
//         filament of relatively rigid or flexible material provided in a variety
//         of diameters.
...
// WireTable is Table of leaf {{block(Component)}} composed of a string like piece or
//         filament of relatively rigid or flexible material provided in a variety
//         of diameters.
...
// ClockTimeTableEntryType is Constraints for Cell Values
type ClockTimeTableEntryType struct {
	Cell []*ClockTimeCellType `xml:"Cell"`
	*EntryType
}

// ClockTimeTableEntry is Table Entry of {{def(EventEnum:CLOCK_TIME)}}
type ClockTimeTableEntry *ClockTimeTableEntryType

// ClockTimeCellType is Cell of {{def(EventEnum:CLOCK_TIME)}}
type ClockTimeCellType struct {
}

// ClockTimeCell is Cell of {{def(EventEnum:CLOCK_TIME)}}
type ClockTimeCell *ClockTimeCellType

// ClockTimeTableType is Constraints for Entry Values
type ClockTimeTableType struct {
	CountAttr int                        `xml:"count,attr"`
	Entry     []*ClockTimeTableEntryType `xml:"Entry"`
	*EventType
}

// ClockTimeTable is Table of {{def(EventEnum:CLOCK_TIME)}}
type ClockTimeTable *ClockTimeTableType

// NetworkPortTableEntryType is Constraints for Cell Values
type NetworkPortTableEntryType struct {
	Cell []*NetworkPortCellType `xml:"Cell"`
	*EntryType
}

// NetworkPortTableEntry is Table Entry of {{def(EventEnum:NETWORK_PORT)}}
type NetworkPortTableEntry *NetworkPortTableEntryType

// NetworkPortCellType is Cell of {{def(EventEnum:NETWORK_PORT)}}
type NetworkPortCellType struct {
}

// NetworkPortCell is Cell of {{def(EventEnum:NETWORK_PORT)}}
type NetworkPortCell *NetworkPortCellType

// NetworkPortTableType is Constraints for Entry Values
type NetworkPortTableType struct {
	CountAttr int                          `xml:"count,attr"`
	Entry     []*NetworkPortTableEntryType `xml:"Entry"`
	*EventType
}

// NetworkPortTable is Table of {{def(EventEnum:NETWORK_PORT)}}
type NetworkPortTable *NetworkPortTableType

// HostNameTableEntryType is Constraints for Cell Values
type HostNameTableEntryType struct {
	Cell []*HostNameCellType `xml:"Cell"`
	*EntryType
}

// HostNameTableEntry is Table Entry of {{def(EventEnum:HOST_NAME)}}
type HostNameTableEntry *HostNameTableEntryType

// HostNameCellType is Cell of {{def(EventEnum:HOST_NAME)}}
type HostNameCellType struct {
}

// HostNameCell is Cell of {{def(EventEnum:HOST_NAME)}}
type HostNameCell *HostNameCellType

// HostNameTableType is Constraints for Entry Values
type HostNameTableType struct {
	CountAttr int                       `xml:"count,attr"`
	Entry     []*HostNameTableEntryType `xml:"Entry"`
	*EventType
}

// HostNameTable is Table of {{def(EventEnum:HOST_NAME)}}
type HostNameTable *HostNameTableType

// LeakDetectTableEntryType is Constraints for Cell Values
type LeakDetectTableEntryType struct {
	Cell []*LeakDetectCellType `xml:"Cell"`
	*EntryType
}

// LeakDetectTableEntry is Table Entry of {{def(EventEnum:LEAK_DETECT)}}
type LeakDetectTableEntry *LeakDetectTableEntryType

// LeakDetectCellType is Cell of {{def(EventEnum:LEAK_DETECT)}}
type LeakDetectCellType struct {
}

// LeakDetectCell is Cell of {{def(EventEnum:LEAK_DETECT)}}
type LeakDetectCell *LeakDetectCellType

// LeakDetectTableType is Constraints for Entry Values
type LeakDetectTableType struct {
	CountAttr int                         `xml:"count,attr"`
	Entry     []*LeakDetectTableEntryType `xml:"Entry"`
	*EventType
}

// LeakDetectTable is Table of {{def(EventEnum:LEAK_DETECT)}}
type LeakDetectTable *LeakDetectTableType

// BatteryStateTableEntryType is Constraints for Cell Values
type BatteryStateTableEntryType struct {
	Cell []*BatteryStateCellType `xml:"Cell"`
	*EntryType
}

// BatteryStateTableEntry is Table Entry of {{def(EventEnum:BATTERY_STATE)}}
type BatteryStateTableEntry *BatteryStateTableEntryType

// BatteryStateCellType is Cell of {{def(EventEnum:BATTERY_STATE)}}
type BatteryStateCellType struct {
}

// BatteryStateCell is Cell of {{def(EventEnum:BATTERY_STATE)}}
type BatteryStateCell *BatteryStateCellType

// BatteryStateTableType is Constraints for Entry Values
type BatteryStateTableType struct {
	CountAttr int                           `xml:"count,attr"`
	Entry     []*BatteryStateTableEntryType `xml:"Entry"`
	*EventType
}

// BatteryStateTable is Table of {{def(EventEnum:BATTERY_STATE)}}
type BatteryStateTable *BatteryStateTableType

// FeaturePersisitentIdTableEntryType is Constraints for Cell Values
type FeaturePersisitentIdTableEntryType struct {
	Cell []*FeaturePersisitentIdCellType `xml:"Cell"`
	*EntryType
}

// FeaturePersisitentIdTableEntry is Table Entry of {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentIdTableEntry *FeaturePersisitentIdTableEntryType

// FeaturePersisitentIdCellType is Cell of {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentIdCellType struct {
}

// FeaturePersisitentIdCell is Cell of {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentIdCell *FeaturePersisitentIdCellType

// FeaturePersisitentIdTableType is Constraints for Entry Values
type FeaturePersisitentIdTableType struct {
	CountAttr int                                   `xml:"count,attr"`
	Entry     []*FeaturePersisitentIdTableEntryType `xml:"Entry"`
	*EventType
}

// FeaturePersisitentIdTable is Table of {{def(EventEnum:FEATURE_PERSISTENT_ID)}}
type FeaturePersisitentIdTable *FeaturePersisitentIdTableType

// SensorStateTableEntryType is Constraints for Cell Values
type SensorStateTableEntryType struct {
	Cell []*SensorStateCellType `xml:"Cell"`
	*EntryType
}

// SensorStateTableEntry is Table Entry of {{def(EventEnum:SENSOR_STATE)}}
type SensorStateTableEntry *SensorStateTableEntryType

// SensorStateCellType is Cell of {{def(EventEnum:SENSOR_STATE)}}
type SensorStateCellType struct {
}

// SensorStateCell is Cell of {{def(EventEnum:SENSOR_STATE)}}
type SensorStateCell *SensorStateCellType

// SensorStateTableType is Constraints for Entry Values
type SensorStateTableType struct {
	CountAttr int                          `xml:"count,attr"`
	Entry     []*SensorStateTableEntryType `xml:"Entry"`
	*EventType
}

// SensorStateTable is Table of {{def(EventEnum:SENSOR_STATE)}}
type SensorStateTable *SensorStateTableType

// ComponentDataTableEntryType is Constraints for Cell Values
type ComponentDataTableEntryType struct {
	Cell []*ComponentDataCellType `xml:"Cell"`
	*EntryType
}

// ComponentDataTableEntry is Table Entry of tabular {{def(EventEnum:COMPONENT_DATA)}} If the
//         {{block(Component)}} multiplicity can be determined, the device model
//         **MUST** use a fixed set of {{block(Component)}}s.
//         {{block(ComponentData)}} **MUST** provide a {{block(DataItem)}}
//         {{block(Definition)}}.
type ComponentDataTableEntry *ComponentDataTableEntryType

// ComponentDataCellType is Cell of tabular {{def(EventEnum:COMPONENT_DATA)}} If the
//         {{block(Component)}} multiplicity can be determined, the device model
//         **MUST** use a fixed set of {{block(Component)}}s.
//         {{block(ComponentData)}} **MUST** provide a {{block(DataItem)}}
//         {{block(Definition)}}.
type ComponentDataCellType struct {
}

// ComponentDataCell is Cell of tabular {{def(EventEnum:COMPONENT_DATA)}} If the
//         {{block(Component)}} multiplicity can be determined, the device model
//         **MUST** use a fixed set of {{block(Component)}}s.
//         {{block(ComponentData)}} **MUST** provide a {{block(DataItem)}}
//         {{block(Definition)}}.
type ComponentDataCell *ComponentDataCellType

// ComponentDataTableType is Constraints for Entry Values
type ComponentDataTableType struct {
	CountAttr int                            `xml:"count,attr"`
	Entry     []*ComponentDataTableEntryType `xml:"Entry"`
	*EventType
}

// ComponentDataTable is Table of tabular {{def(EventEnum:COMPONENT_DATA)}} If the
//         {{block(Component)}} multiplicity can be determined, the device model
//         **MUST** use a fixed set of {{block(Component)}}s.
//         {{block(ComponentData)}} **MUST** provide a {{block(DataItem)}}
//         {{block(Definition)}}.
type ComponentDataTable *ComponentDataTableType

// WorkOffsetsTableEntryType is Constraints for Cell Values
type WorkOffsetsTableEntryType struct {
	Cell []*WorkOffsetsCellType `xml:"Cell"`
	*EntryType
}

// WorkOffsetsTableEntry is Table Entry of tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsetsTableEntry *WorkOffsetsTableEntryType

// WorkOffsetsCellType is Cell of tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsetsCellType struct {
}

// WorkOffsetsCell is Cell of tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsetsCell *WorkOffsetsCellType

// WorkOffsetsTableType is Constraints for Entry Values
type WorkOffsetsTableType struct {
	CountAttr int                          `xml:"count,attr"`
	Entry     []*WorkOffsetsTableEntryType `xml:"Entry"`
	*EventType
}

// WorkOffsetsTable is Table of tabular representation of {{def(EventEnum:WORK_OFFSETS)}}
type WorkOffsetsTable *WorkOffsetsTableType

// ToolOffsetsTableEntryType is Constraints for Cell Values
type ToolOffsetsTableEntryType struct {
	Cell []*ToolOffsetsCellType `xml:"Cell"`
	*EntryType
}

// ToolOffsetsTableEntry is Table Entry of tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsetsTableEntry *ToolOffsetsTableEntryType

// ToolOffsetsCellType is Cell of tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsetsCellType struct {
}

// ToolOffsetsCell is Cell of tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsetsCell *ToolOffsetsCellType

// ToolOffsetsTableType is Constraints for Entry Values
type ToolOffsetsTableType struct {
	CountAttr int                          `xml:"count,attr"`
	Entry     []*ToolOffsetsTableEntryType `xml:"Entry"`
	*EventType
}

// ToolOffsetsTable is Table of tabular representation of {{def(EventEnum:TOOL_OFFSETS)}}
type ToolOffsetsTable *ToolOffsetsTableType

// FeatureMeasurementTableEntryType is Constraints for Cell Values
type FeatureMeasurementTableEntryType struct {
	Cell []*FeatureMeasurementCellType `xml:"Cell"`
	*EntryType
}

// FeatureMeasurementTableEntry is Table Entry of tabular representation of
//         {{def(EventEnum:FEATURE_MEASUREMENT)}} {{block(FeatureMeasurement)}}
//         **MAY** include a {{term(characteristic)}} in which case it **MAY**
//         include a `CHARACTERISTIC_STATUS`.
type FeatureMeasurementTableEntry *FeatureMeasurementTableEntryType

// FeatureMeasurementCellType is Cell of tabular representation of {{def(EventEnum:FEATURE_MEASUREMENT)}}
//         {{block(FeatureMeasurement)}} **MAY** include a {{term(characteristic)}}
//         in which case it **MAY** include a `CHARACTERISTIC_STATUS`.
type FeatureMeasurementCellType struct {
}

// FeatureMeasurementCell is Cell of tabular representation of {{def(EventEnum:FEATURE_MEASUREMENT)}}
//         {{block(FeatureMeasurement)}} **MAY** include a {{term(characteristic)}}
//         in which case it **MAY** include a `CHARACTERISTIC_STATUS`.
type FeatureMeasurementCell *FeatureMeasurementCellType

// FeatureMeasurementTableType is Constraints for Entry Values
type FeatureMeasurementTableType struct {
	CountAttr int                                 `xml:"count,attr"`
	Entry     []*FeatureMeasurementTableEntryType `xml:"Entry"`
	*EventType
}

// FeatureMeasurementTable is Table of tabular representation of
//         {{def(EventEnum:FEATURE_MEASUREMENT)}} {{block(FeatureMeasurement)}}
//         **MAY** include a {{term(characteristic)}} in which case it **MAY**
//         include a `CHARACTERISTIC_STATUS`.
type FeatureMeasurementTable *FeatureMeasurementTableType

// CharacteristicPersistentIdTableEntryType is Constraints for Cell Values
type CharacteristicPersistentIdTableEntryType struct {
	Cell []*CharacteristicPersistentIdCellType `xml:"Cell"`
	*EntryType
}

// CharacteristicPersistentIdTableEntry is Table Entry of {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentIdTableEntry *CharacteristicPersistentIdTableEntryType

// CharacteristicPersistentIdCellType is Cell of {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentIdCellType struct {
}

// CharacteristicPersistentIdCell is Cell of {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentIdCell *CharacteristicPersistentIdCellType

// CharacteristicPersistentIdTableType is Constraints for Entry Values
type CharacteristicPersistentIdTableType struct {
	CountAttr int                                         `xml:"count,attr"`
	Entry     []*CharacteristicPersistentIdTableEntryType `xml:"Entry"`
	*EventType
}

// CharacteristicPersistentIdTable is Table of {{def(EventEnum:CHARACTERISTIC_PERSISTENT_ID)}}
type CharacteristicPersistentIdTable *CharacteristicPersistentIdTableType

// MeasurementTypeTableEntryType is Constraints for Cell Values
type MeasurementTypeTableEntryType struct {
	Cell []*MeasurementTypeCellType `xml:"Cell"`
	*EntryType
}

// MeasurementTypeTableEntry is Table Entry of {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`,
//         `RADIUS`, `ANGLE`, `LENGTH`, etc.
type MeasurementTypeTableEntry *MeasurementTypeTableEntryType

// MeasurementTypeCellType is Cell of {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`, `RADIUS`,
//         `ANGLE`, `LENGTH`, etc.
type MeasurementTypeCellType struct {
}

// MeasurementTypeCell is Cell of {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`, `RADIUS`,
//         `ANGLE`, `LENGTH`, etc.
type MeasurementTypeCell *MeasurementTypeCellType

// MeasurementTypeTableType is Constraints for Entry Values
type MeasurementTypeTableType struct {
	CountAttr int                              `xml:"count,attr"`
	Entry     []*MeasurementTypeTableEntryType `xml:"Entry"`
	*EventType
}

// MeasurementTypeTable is Table of {{def(EventEnum:MEASUREMENT_TYPE)}} Examples: `POINT`,
//         `RADIUS`, `ANGLE`, `LENGTH`, etc.
type MeasurementTypeTable *MeasurementTypeTableType

// MeasurementValueTableEntryType is Constraints for Cell Values
type MeasurementValueTableEntryType struct {
	Cell []*MeasurementValueCellType `xml:"Cell"`
	*EntryType
}

// MeasurementValueTableEntry is Table Entry of {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValueTableEntry *MeasurementValueTableEntryType

// MeasurementValueCellType is Cell of {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValueCellType struct {
}

// MeasurementValueCell is Cell of {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValueCell *MeasurementValueCellType

// MeasurementValueTableType is Constraints for Entry Values
type MeasurementValueTableType struct {
	CountAttr int                               `xml:"count,attr"`
	Entry     []*MeasurementValueTableEntryType `xml:"Entry"`
	*EventType
}

// MeasurementValueTable is Table of {{def(EventEnum:MEASUREMENT_VALUE)}}
type MeasurementValueTable *MeasurementValueTableType

// MeasurementUnitsTableEntryType is Constraints for Cell Values
type MeasurementUnitsTableEntryType struct {
	Cell []*MeasurementUnitsCellType `xml:"Cell"`
	*EntryType
}

// MeasurementUnitsTableEntry is Table Entry of {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnitsTableEntry *MeasurementUnitsTableEntryType

// MeasurementUnitsCellType is Cell of {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnitsCellType struct {
}

// MeasurementUnitsCell is Cell of {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnitsCell *MeasurementUnitsCellType

// MeasurementUnitsTableType is Constraints for Entry Values
type MeasurementUnitsTableType struct {
	CountAttr int                               `xml:"count,attr"`
	Entry     []*MeasurementUnitsTableEntryType `xml:"Entry"`
	*EventType
}

// MeasurementUnitsTable is Table of {{def(EventEnum:MEASUREMENT_UNITS)}}
type MeasurementUnitsTable *MeasurementUnitsTableType

// CharacteristicStatusTableEntryType is Constraints for Cell Values
type CharacteristicStatusTableEntryType struct {
	Cell []*CharacteristicStatusCellType `xml:"Cell"`
	*EntryType
}

// CharacteristicStatusTableEntry is Table Entry of {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatusTableEntry *CharacteristicStatusTableEntryType

// CharacteristicStatusCellType is Cell of {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatusCellType struct {
}

// CharacteristicStatusCell is Cell of {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatusCell *CharacteristicStatusCellType

// CharacteristicStatusTableType is Constraints for Entry Values
type CharacteristicStatusTableType struct {
	CountAttr int                                   `xml:"count,attr"`
	Entry     []*CharacteristicStatusTableEntryType `xml:"Entry"`
	*EventType
}

// CharacteristicStatusTable is Table of {{def(EventEnum:CHARACTERISTIC_STATUS)}}
type CharacteristicStatusTable *CharacteristicStatusTableType

// UncertaintyTypeTableEntryType is Constraints for Cell Values
type UncertaintyTypeTableEntryType struct {
	Cell []*UncertaintyTypeCellType `xml:"Cell"`
	*EntryType
}

// UncertaintyTypeTableEntry is Table Entry of {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyTypeTableEntry *UncertaintyTypeTableEntryType

// UncertaintyTypeCellType is Cell of {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyTypeCellType struct {
}

// UncertaintyTypeCell is Cell of {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyTypeCell *UncertaintyTypeCellType

// UncertaintyTypeTableType is Constraints for Entry Values
type UncertaintyTypeTableType struct {
	CountAttr int                              `xml:"count,attr"`
	Entry     []*UncertaintyTypeTableEntryType `xml:"Entry"`
	*EventType
}

// UncertaintyTypeTable is Table of {{def(EventEnum:UNCERTAINTY_TYPE)}}
type UncertaintyTypeTable *UncertaintyTypeTableType

// UncertaintyTableEntryType is Constraints for Cell Values
type UncertaintyTableEntryType struct {
	Cell []*UncertaintyCellType `xml:"Cell"`
	*EntryType
}

// UncertaintyTableEntry is Table Entry of {{def(EventEnum:UNCERTAINTY)}}
type UncertaintyTableEntry *UncertaintyTableEntryType

// UncertaintyCellType is Cell of {{def(EventEnum:UNCERTAINTY)}}
type UncertaintyCellType struct {
}

// UncertaintyCell is Cell of {{def(EventEnum:UNCERTAINTY)}}
type UncertaintyCell *UncertaintyCellType

// UncertaintyTableType is Constraints for Entry Values
type UncertaintyTableType struct {
	CountAttr int                          `xml:"count,attr"`
	Entry     []*UncertaintyTableEntryType `xml:"Entry"`
	*EventType
}

// UncertaintyTable is Table of {{def(EventEnum:UNCERTAINTY)}}
type UncertaintyTable *UncertaintyTableType
...
// DewPointTableEntryType is Constraints for Cell Values
type DewPointTableEntryType struct {
	Cell []*DewPointCellType `xml:"Cell"`
	*EntryType
}

// DewPointTableEntry is Table Entry of {{def(SampleEnum:DEW_POINT)}}
type DewPointTableEntry *DewPointTableEntryType

// DewPointCellType is Cell of {{def(SampleEnum:DEW_POINT)}}
type DewPointCellType struct {
}

// DewPointCell is Cell of {{def(SampleEnum:DEW_POINT)}}
type DewPointCell *DewPointCellType

// DewPointTableType is Constraints for Entry Values
type DewPointTableType struct {
	CountAttr int                       `xml:"count,attr"`
	Entry     []*DewPointTableEntryType `xml:"Entry"`
	*EventType
}

// DewPointTable is Table of {{def(SampleEnum:DEW_POINT)}}
type DewPointTable *DewPointTableType

// GravitationalForceTableEntryType is Constraints for Cell Values
type GravitationalForceTableEntryType struct {
	Cell []*GravitationalForceCellType `xml:"Cell"`
	*EntryType
}

// GravitationalForceTableEntry is Table Entry of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note:
//         $$Mass\times GravitationalAcceleration$$
type GravitationalForceTableEntry *GravitationalForceTableEntryType

// GravitationalForceCellType is Cell of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note: $$Mass\times
//         GravitationalAcceleration$$
type GravitationalForceCellType struct {
}

// GravitationalForceCell is Cell of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note: $$Mass\times
//         GravitationalAcceleration$$
type GravitationalForceCell *GravitationalForceCellType

// GravitationalForceTableType is Constraints for Entry Values
type GravitationalForceTableType struct {
	CountAttr int                                 `xml:"count,attr"`
	Entry     []*GravitationalForceTableEntryType `xml:"Entry"`
	*EventType
}

// GravitationalForceTable is Table of {{def(SampleEnum:GRAVITATIONAL_FORCE)}} > Note: $$Mass\times
//         GravitationalAcceleration$$
type GravitationalForceTable *GravitationalForceTableType

// GravitationalAccelerationTableEntryType is Constraints for Cell Values
type GravitationalAccelerationTableEntryType struct {
	Cell []*GravitationalAccelerationCellType `xml:"Cell"`
	*EntryType
}

// GravitationalAccelerationTableEntry is Table Entry of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationTableEntry *GravitationalAccelerationTableEntryType

// GravitationalAccelerationCellType is Cell of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationCellType struct {
}

// GravitationalAccelerationCell is Cell of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationCell *GravitationalAccelerationCellType

// GravitationalAccelerationTableType is Constraints for Entry Values
type GravitationalAccelerationTableType struct {
	CountAttr int                                        `xml:"count,attr"`
	Entry     []*GravitationalAccelerationTableEntryType `xml:"Entry"`
	*EventType
}

// GravitationalAccelerationTable is Table of {{def(SampleEnum:GRAVITATIONAL_ACCELERATION)}}
type GravitationalAccelerationTable *GravitationalAccelerationTableType

// BatteryCapacityTableEntryType is Constraints for Cell Values
type BatteryCapacityTableEntryType struct {
	Cell []*BatteryCapacityCellType `xml:"Cell"`
	*EntryType
}

// BatteryCapacityTableEntry is Table Entry of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityTableEntry *BatteryCapacityTableEntryType

// BatteryCapacityCellType is Cell of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityCellType struct {
}

// BatteryCapacityCell is Cell of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityCell *BatteryCapacityCellType

// BatteryCapacityTableType is Constraints for Entry Values
type BatteryCapacityTableType struct {
	CountAttr int                              `xml:"count,attr"`
	Entry     []*BatteryCapacityTableEntryType `xml:"Entry"`
	*EventType
}

// BatteryCapacityTable is Table of {{def(SampleEnum:BATTERY_CAPACITY)}}
type BatteryCapacityTable *BatteryCapacityTableType

// DischargeRateTableEntryType is Constraints for Cell Values
type DischargeRateTableEntryType struct {
	Cell []*DischargeRateCellType `xml:"Cell"`
	*EntryType
}

// DischargeRateTableEntry is Table Entry of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateTableEntry *DischargeRateTableEntryType

// DischargeRateCellType is Cell of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateCellType struct {
}

// DischargeRateCell is Cell of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateCell *DischargeRateCellType

// DischargeRateTableType is Constraints for Entry Values
type DischargeRateTableType struct {
	CountAttr int                            `xml:"count,attr"`
	Entry     []*DischargeRateTableEntryType `xml:"Entry"`
	*EventType
}

// DischargeRateTable is Table of {{def(SampleEnum:DISCHARGE_RATE)}}
type DischargeRateTable *DischargeRateTableType

// ChargeRateTableEntryType is Constraints for Cell Values
type ChargeRateTableEntryType struct {
	Cell []*ChargeRateCellType `xml:"Cell"`
	*EntryType
}

// ChargeRateTableEntry is Table Entry of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateTableEntry *ChargeRateTableEntryType

// ChargeRateCellType is Cell of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateCellType struct {
}

// ChargeRateCell is Cell of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateCell *ChargeRateCellType

// ChargeRateTableType is Constraints for Entry Values
type ChargeRateTableType struct {
	CountAttr int                         `xml:"count,attr"`
	Entry     []*ChargeRateTableEntryType `xml:"Entry"`
	*EventType
}

// ChargeRateTable is Table of {{def(SampleEnum:CHARGE_RATE)}}
type ChargeRateTable *ChargeRateTableType

// BatteryChargeTableEntryType is Constraints for Cell Values
type BatteryChargeTableEntryType struct {
	Cell []*BatteryChargeCellType `xml:"Cell"`
	*EntryType
}

// BatteryChargeTableEntry is Table Entry of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeTableEntry *BatteryChargeTableEntryType

// BatteryChargeCellType is Cell of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeCellType struct {
}

// BatteryChargeCell is Cell of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeCell *BatteryChargeCellType

// BatteryChargeTableType is Constraints for Entry Values
type BatteryChargeTableType struct {
	CountAttr int                            `xml:"count,attr"`
	Entry     []*BatteryChargeTableEntryType `xml:"Entry"`
	*EventType
}

// BatteryChargeTable is Table of {{def(SampleEnum:BATTERY_CHARGE)}}
type BatteryChargeTable *BatteryChargeTableType

// SettlingErrorTableEntryType is Constraints for Cell Values
type SettlingErrorTableEntryType struct {
	Cell []*SettlingErrorCellType `xml:"Cell"`
	*EntryType
}

// SettlingErrorTableEntry is Table Entry of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorTableEntry *SettlingErrorTableEntryType

// SettlingErrorCellType is Cell of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorCellType struct {
}

// SettlingErrorCell is Cell of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorCell *SettlingErrorCellType

// SettlingErrorTableType is Constraints for Entry Values
type SettlingErrorTableType struct {
	CountAttr int                            `xml:"count,attr"`
	Entry     []*SettlingErrorTableEntryType `xml:"Entry"`
	*EventType
}

// SettlingErrorTable is Table of {{def(SampleEnum:SETTLING_ERROR)}}
type SettlingErrorTable *SettlingErrorTableType

// SettlingErrorLinearTableEntryType is Constraints for Cell Values
type SettlingErrorLinearTableEntryType struct {
	Cell []*SettlingErrorLinearCellType `xml:"Cell"`
	*EntryType
}

// SettlingErrorLinearTableEntry is Table Entry of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearTableEntry *SettlingErrorLinearTableEntryType

// SettlingErrorLinearCellType is Cell of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearCellType struct {
}

// SettlingErrorLinearCell is Cell of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearCell *SettlingErrorLinearCellType

// SettlingErrorLinearTableType is Constraints for Entry Values
type SettlingErrorLinearTableType struct {
	CountAttr int                                  `xml:"count,attr"`
	Entry     []*SettlingErrorLinearTableEntryType `xml:"Entry"`
	*EventType
}

// SettlingErrorLinearTable is Table of {{def(SampleEnum:SETTLING_ERROR_LINEAR)}}
type SettlingErrorLinearTable *SettlingErrorLinearTableType

// SettlingErrorAngularTableEntryType is Constraints for Cell Values
type SettlingErrorAngularTableEntryType struct {
	Cell []*SettlingErrorAngularCellType `xml:"Cell"`
	*EntryType
}

// SettlingErrorAngularTableEntry is Table Entry of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularTableEntry *SettlingErrorAngularTableEntryType

// SettlingErrorAngularCellType is Cell of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularCellType struct {
}

// SettlingErrorAngularCell is Cell of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularCell *SettlingErrorAngularCellType

// SettlingErrorAngularTableType is Constraints for Entry Values
type SettlingErrorAngularTableType struct {
	CountAttr int                                   `xml:"count,attr"`
	Entry     []*SettlingErrorAngularTableEntryType `xml:"Entry"`
	*EventType
}

// SettlingErrorAngularTable is Table of {{def(SampleEnum:SETTLING_ERROR_ANGULAR)}}
type SettlingErrorAngularTable *SettlingErrorAngularTableType

// FollowingErrorTableEntryType is Constraints for Cell Values
type FollowingErrorTableEntryType struct {
	Cell []*FollowingErrorCellType `xml:"Cell"`
	*EntryType
}

// FollowingErrorTableEntry is Table Entry of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorTableEntry *FollowingErrorTableEntryType

// FollowingErrorCellType is Cell of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorCellType struct {
}

// FollowingErrorCell is Cell of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorCell *FollowingErrorCellType

// FollowingErrorTableType is Constraints for Entry Values
type FollowingErrorTableType struct {
	CountAttr int                             `xml:"count,attr"`
	Entry     []*FollowingErrorTableEntryType `xml:"Entry"`
	*EventType
}

// FollowingErrorTable is Table of {{def(SampleEnum:FOLLOWING_ERROR)}}
type FollowingErrorTable *FollowingErrorTableType

// FollowingErrorAngularTableEntryType is Constraints for Cell Values
type FollowingErrorAngularTableEntryType struct {
	Cell []*FollowingErrorAngularCellType `xml:"Cell"`
	*EntryType
}

// FollowingErrorAngularTableEntry is Table Entry of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularTableEntry *FollowingErrorAngularTableEntryType

// FollowingErrorAngularCellType is Cell of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularCellType struct {
}

// FollowingErrorAngularCell is Cell of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularCell *FollowingErrorAngularCellType

// FollowingErrorAngularTableType is Constraints for Entry Values
type FollowingErrorAngularTableType struct {
	CountAttr int                                    `xml:"count,attr"`
	Entry     []*FollowingErrorAngularTableEntryType `xml:"Entry"`
	*EventType
}

// FollowingErrorAngularTable is Table of {{def(SampleEnum:FOLLOWING_ERROR_ANGULAR)}}
type FollowingErrorAngularTable *FollowingErrorAngularTableType

// FollowingErrorLinearTableEntryType is Constraints for Cell Values
type FollowingErrorLinearTableEntryType struct {
	Cell []*FollowingErrorLinearCellType `xml:"Cell"`
	*EntryType
}

// FollowingErrorLinearTableEntry is Table Entry of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearTableEntry *FollowingErrorLinearTableEntryType

// FollowingErrorLinearCellType is Cell of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearCellType struct {
}

// FollowingErrorLinearCell is Cell of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearCell *FollowingErrorLinearCellType

// FollowingErrorLinearTableType is Constraints for Entry Values
type FollowingErrorLinearTableType struct {
	CountAttr int                                   `xml:"count,attr"`
	Entry     []*FollowingErrorLinearTableEntryType `xml:"Entry"`
	*EventType
}

// FollowingErrorLinearTable is Table of {{def(SampleEnum:FOLLOWING_ERROR_LINEAR)}}
type FollowingErrorLinearTable *FollowingErrorLinearTableType

// DisplacementLinearTableEntryType is Constraints for Cell Values
type DisplacementLinearTableEntryType struct {
	Cell []*DisplacementLinearCellType `xml:"Cell"`
	*EntryType
}

// DisplacementLinearTableEntry is Table Entry of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearTableEntry *DisplacementLinearTableEntryType

// DisplacementLinearCellType is Cell of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearCellType struct {
}

// DisplacementLinearCell is Cell of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearCell *DisplacementLinearCellType

// DisplacementLinearTableType is Constraints for Entry Values
type DisplacementLinearTableType struct {
	CountAttr int                                 `xml:"count,attr"`
	Entry     []*DisplacementLinearTableEntryType `xml:"Entry"`
	*EventType
}

// DisplacementLinearTable is Table of {{def(SampleEnum:DISPLACEMENT_LINEAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementLinearTable *DisplacementLinearTableType

// DisplacementAngularTableEntryType is Constraints for Cell Values
type DisplacementAngularTableEntryType struct {
	Cell []*DisplacementAngularCellType `xml:"Cell"`
	*EntryType
}

// DisplacementAngularTableEntry is Table Entry of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularTableEntry *DisplacementAngularTableEntryType

// DisplacementAngularCellType is Cell of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularCellType struct {
}

// DisplacementAngularCell is Cell of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularCell *DisplacementAngularCellType

// DisplacementAngularTableType is Constraints for Entry Values
type DisplacementAngularTableType struct {
	CountAttr int                                  `xml:"count,attr"`
	Entry     []*DisplacementAngularTableEntryType `xml:"Entry"`
	*EventType
}

// DisplacementAngularTable is Table of {{def(SampleEnum:DISPLACEMENT_ANGULAR)}} > Note: The
//         displacement vector **MAY** be defined by the motion of the owning
//         {{block(Component)}}.
type DisplacementAngularTable *DisplacementAngularTableType

// PositionCartesianTableEntryType is Constraints for Cell Values
type PositionCartesianTableEntryType struct {
	Cell []*PositionCartesianCellType `xml:"Cell"`
	*EntryType
}

// PositionCartesianTableEntry is Table Entry of {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesianTableEntry *PositionCartesianTableEntryType

// PositionCartesianCellType is Cell of {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesianCellType struct {
}

// PositionCartesianCell is Cell of {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesianCell *PositionCartesianCellType

// PositionCartesianTableType is Constraints for Entry Values
type PositionCartesianTableType struct {
	CountAttr int                                `xml:"count,attr"`
	Entry     []*PositionCartesianTableEntryType `xml:"Entry"`
	*EventType
}

// PositionCartesianTable is Table of {{def(SampleEnum:POSITION_CARTESIAN)}}
type PositionCartesianTable *PositionCartesianTableType
