...
// DoorType is {{block(Composition)}} that can cover a physical access portal into a
...
// Door is {{block(Composition)}} that can cover a physical access portal into a
//         piece of equipment allowing or restricting access to other parts of the
//         equipment.
type Door *DoorType
...
// ChuckType is {{block(Composition)}} that holds a part, stock material, or any other
//         item in place.
type ChuckType struct {
	*CommonComponentType
}

// Chuck is {{block(Composition)}} that holds a part, stock material, or any other
//         item in place.
...
// RelationshipsType is {{block(Relationships)}} groups one or more {{block(Relationship)}}
...
// Relationships is {{block(Relationships)}} groups one or more {{block(Relationship)}}
//         types. See {{package(Relationships)}}.
...
// RelationshipType is Description
...
// Relationship is Description
type Relationship *RelationshipType

// ComponentRelationshipType is {{block(Relationship)}} that describes the association between two
...
// ComponentRelationship is {{block(Relationship)}} that describes the association between two
//         components within a piece of equipment that function independently but
//         together perform a capability or service within a piece of equipment.
type ComponentRelationship *ComponentRelationshipType

// DeviceRelationshipType is {{block(Relationship)}} that describes the association between two
...
// DeviceRelationship is {{block(Relationship)}} that describes the association between two
//         pieces of equipment that function independently but together perform a
//         manufacturing operation.
